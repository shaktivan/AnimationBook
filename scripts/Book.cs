...
public class Book : MonoBehaviour {
    ...
    public void UpdateBookLTRToPoint(Vector3 followLocation)
    {
        ...
        {
            float a = Mathf.Clamp01(Vector2.Distance(c, ebr) / (radius1 * 0.5f));
            Color sc = ShadowLTR.color; sc.a = a; ShadowLTR.color = sc;
        }
        Vector3 t1;
    ...
    public void UpdateBookRTLToPoint(Vector3 followLocation)
    {
        ...
        if (enableShadowEffect)
        {
            float a = Mathf.Clamp01(Vector2.Distance(c, ebl) / (radius1 * 0.5f));
            Color sc = Shadow.color; sc.a = a; Shadow.color = sc;
        }
        Vector3 t1;
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        if (enableShadowEffect)
        {
            ShadowLTR.color = new Color(ShadowLTR.color.r, ShadowLTR.color.g, ShadowLTR.color.b, 1f);
